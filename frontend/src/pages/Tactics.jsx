        ...
        >
              ...
              <div>
                <h2 className="text-3xl font-bold text-white mb-2">
                  {isLoading
                    ...
                    : formation?.formation || "Standard Formation"}
                </h2>
                <p className="text-gray-lightest">
                  Optimal positioning based on soldier metrics and terrain
                  analysis
                </p>
              </div>
            ...
            <div className="relative w-full h-[60vh] bg-gray-dark bg-opacity-40 rounded-lg border border-gray-medium overflow-hidden">
              ...
              <div className="absolute inset-0 grid grid-cols-10 grid-rows-10">
                {Array.from({ length: 100 }).map((_, i) => (
                  <div
                    key={i}
                    className="border border-gray-dark border-opacity-10"
                  ></div>
                ))}
              </div>
              ...
              {soldierPositions.map((soldier) => (
                <div
                  key={soldier.id}
                  className={`absolute w-6 h-6 rounded-full ${getSoldierColor(
                    soldier.efficiency
                  )} shadow-lg transform hover:scale-125 transition-transform duration-300 flex items-center justify-center text-xs font-bold text-white border-2 border-white`}
                  style={{
                    left: `${soldier.x}%`,
                    top: `${soldier.y}%`,
              ...
              <div className="absolute bottom-4 right-4 bg-black-primary bg-opacity-60 rounded-full p-3">
                <svg
                  className="w-8 h-8 text-gray-lightest"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-black-secondary rounded-xl p-6 shadow-lg border border-gray-dark hover:border-gray-medium transition-all duration-300">
              ...
              <p className="text-gray-lightest mb-3">
                High ground toward the north, providing tactical advantage for
                ranged soldiers.
              </p>
            ...
            <div className="bg-black-secondary rounded-xl p-6 shadow-lg border border-gray-dark hover:border-gray-medium transition-all duration-300">
              ...
              <p className="text-gray-lightest mb-3">
                Formation optimized for maximum strike efficiency based on
                soldier capabilities.
              </p>
              <div className="w-full bg-gray-dark rounded-full h-2 mb-1">
                <div
                  className={`${strikeSuccessColor()} h-2 rounded-full transition-all duration-500`}
                  style={{ width: strikeSuccessWidth() }}
                ></div>
              </div>
              <p className="text-xs text-gray-light">
                {formatStrikeSuccess()} strike success probability
              </p>
            </div>
            ...
            <div className="bg-black-secondary rounded-xl p-6 shadow-lg border border-gray-dark hover:border-gray-medium transition-all duration-300">
              ...
              <p className="text-gray-lightest mb-3">
                Diamond formation with reinforced flanks to maximize coverage
                and defense.
              </p>
